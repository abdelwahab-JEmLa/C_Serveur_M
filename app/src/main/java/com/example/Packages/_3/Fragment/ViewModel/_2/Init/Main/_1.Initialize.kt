            ...
            this._uiState.produit_DataBase.forEach { new_produit_A_Update ->
                ...
                ancienData.produitsDatabase.find { it.idArticle == new_produit_A_Update.id }
                    ?.let { ancien_DataBase ->
                        ...
                        listOf(
                            Triple(
                                ancien_DataBase.idcolor1,
                                1L,
                                new_produit_A_Update.colours_Et_Gouts
                            ),
                            Triple(
                                ancien_DataBase.idcolor2,
                                2L,
                                new_produit_A_Update.colours_Et_Gouts
                            ),
                            Triple(
                                ancien_DataBase.idcolor3,
                                3L,
                                new_produit_A_Update.colours_Et_Gouts
                            ),
                            Triple(
                                ancien_DataBase.idcolor4,
                                4L,
                                new_produit_A_Update.colours_Et_Gouts
                            )
                ...
                new_produit_A_Update.colours_Et_Gouts.forEach { productColor ->
                    val totalQuantity =
                        totalQuantitiesByColor[productColor.position_Du_Couleur_Au_Produit] ?: 0
