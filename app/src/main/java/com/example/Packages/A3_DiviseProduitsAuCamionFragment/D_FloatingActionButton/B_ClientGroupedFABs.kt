package com.example.Packages.A3_DiviseProduitsAuCamionFragment.D_FloatingActionButton
...
fun ClientsGroupedFABs_Fragment_3(
    ...
    // Use derivedStateOf for grouping products with safe access to clientInformations
    ...
    Column(
        ...
        AnimatedVisibility(
            ...
            Column(
                ...
                groupedProducts.forEach { (clientInfo, products) ->
                    key(clientInfo.id) {
                        Row(
                            ...
                            Text(
                                text = "${clientInfo.nom} (${products.size})",
                            ...
                            FloatingActionButton(
                                onClick = {
                                    initViewModel
                                        ...
                                        .ClientsFloatingActionButton(clientInfo,products)
                                },
