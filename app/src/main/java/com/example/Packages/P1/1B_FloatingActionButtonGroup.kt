                ...
                Column(
                    ...
                    listOf(
                        ...
                        FabData(
                            ...
                            label = if (clearDataClickCount == 0) "clear " else "Confirm Clear",
    ...
    Row(
        ...
        AnimatedVisibility(
            ...
            Surface(
                ...
                color = color.copy(alpha = 0.4f) // Light version of the button color for the label
            ) {
                Text(
                    text = label,
